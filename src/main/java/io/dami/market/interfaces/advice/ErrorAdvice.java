...
public class ErrorAdvice {
  ...
  public ResponseEntity<ErrorResponse> paymentAlreadySuccessException(
      PaymentAlreadySuccessException e) {
    log.warn(e.getMessage(), e);
    return ResponseEntity
        .status(482)
  ...
  public ResponseEntity<ErrorResponse> orderAlreadyCanceledException(
      OrderAlreadyCanceledException e) {
    log.warn(e.getMessage(), e);
    return ResponseEntity
        .status(484)
