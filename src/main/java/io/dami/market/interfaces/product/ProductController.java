...
public class ProductController {
    ...
    @GetMapping
    public ResponseEntity<Page<ProductResponse.ProductDetails>> getProducts(@RequestParam(defaultValue = "0") int page) {
    ...
    public ResponseEntity<ProductResponse.ProductDetails> getProductDetails(@PathVariable Long productId) {
        return ResponseEntity.ok(new ProductResponse.ProductDetails(productService.getProductDetails(productId)));
    }
